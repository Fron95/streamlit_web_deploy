...
def main():
    ...
    st.markdown("해당 웹서비스는 더 편리하고 강력한 데이터시각화를 가능하게 합니다." )
    st.markdown("모든 계량적 분석가들은 분석 뿐만 아니라 결과를 직관적으로 표현할 수 있어야 합니다.")
    st.markdown("해당 웹서비스는 코딩에 능하지 않은 일반 사용자도  강력한 시각화 라이브러리인 matplotlib을 활용할 수 있도록 할 목적에서 개발되었습니다.")
    st.markdown("계량분석결과를 직관적으로 만들어보세요!")
